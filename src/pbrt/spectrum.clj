...
(def cie-x (prepare-samples cie-lambda [0.0001299000   0.0001458470   0.0001638021   0.0001840037
...
(def cie-y (prepare-samples cie-lambda [0.000003917000  0.000004393581  0.000004929604  0.000005532136
...
(def cie-z (prepare-samples cie-lambda [0.0006061000 0.0006808792 0.0007651456 0.0008600124
...
(defn resample-linear-spectrum
  "Resample segments using average-spectrum-samples. This is simplified version comparing to original PBRT function."
